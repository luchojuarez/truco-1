...
// Create a new controller method for newgame
// Create a new controller method that renders the newgame page
exports.renderNewgame= function(req, res, next) {
	// If user is connected render the newgame page
	if (req.user) {
		// Use the 'response' object to render the signup page
		res.render('newgame', {
			// Set the page title variable
			title: 'Now playing truco',
			// Set the flash message variable
			messages: req.flash('error')
		});
	} else {
